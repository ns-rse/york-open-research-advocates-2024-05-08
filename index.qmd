...
I don't currently have these up on the OSC Sheffield website but should probably get them on the landing page, but its a
WordPress site that I haven't completely sussed out how to work just yet.
:::
...
At the top of the pyramid is the Open Research Advisory Group who set out how the national policies are to be
implemented. At the bottom under pinning activities are IT Infrastructure and Library services.

Already bridging the middle the pyramid of behaviour change is Jenni Adams and the Open Research Working Group as well
as many other support staff who are actively engaged in undertaking and promoting Open Research here at the University
and Jenni has been very supportive getting OSC Sheffield up and running and already organises a number of events.
:::
...
:::{.notes}
To sum up, thank you for listening, and if this is the first time you've heard about Open Scholarship Community
Sheffield and would like to be involved then please do join and add your profile, you can scan this QR code.
